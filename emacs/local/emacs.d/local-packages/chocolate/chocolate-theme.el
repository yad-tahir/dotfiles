...
(custom-theme-set-faces
 ...
 `(error ((t (:background unspecified :foreground ,chocolate-theme-highlight+1 :weight bold))))
 ...
 `(font-lock-type-face ((t (:foreground ,chocolate-theme-highlight+2))))
 ...
 `(font-lock-regexp-grouping-construct ((t (:foreground ,chocolate-theme-highlight+1))))
 ...
 `(show-paren-mismatch ((t (:background ,chocolate-theme-highlight+1 :foreground ,chocolate-theme-bg))))
 ...
 `(hi-red-b ((t (:foreground ,chocolate-theme-bg :background ,chocolate-theme-highlight+1))))
 ...
 `(org-date ((t (:foreground ,chocolate-theme-highlight+2 :inherit font-lock-string-face))))
 `(org-scheduled-today ((t (:foreground ,chocolate-theme-white))))
 `(org-scheduled ((t (:foreground ,chocolate-theme-white))))
 `(org-scheduled-previously ((t (:foreground ,chocolate-theme-highlight+2))))
 ...
 `(org-habit-overdue-face ((t (:foreground ,chocolate-theme-bg :background ,chocolate-theme-highlight+1))))
 ...
 ;; Evil
 `(evil-ex-substitute-replacement ((t (:foreground ,chocolate-theme-bg :background ,chocolate-theme-highlight+2))))
 ...
 `(ivy-modified-outside-buffer ((t (:inherit nil :background unspecified :foreground ,chocolate-theme-highlight+1 :weight bold))))
 ...
 `(company-preview ((t (:inherit nil :foreground ,chocolate-theme-highlight+1 :background ,chocolate-theme-bg))))
